...
You will also need to make these edits in each of `osg_dir.txt` and `osg_array_lm.sub`.
:::
...
File transfer takes place via *scp* and specifying the source path and destination path as shown::
```{bash}
