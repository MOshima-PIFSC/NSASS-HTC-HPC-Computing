...
## {.center background-image="static/noaa-hera.jpg"}

::: {.titlebox style="text-align:center; font-size: 1.25em;"}

[Operationalizing available research computing resources for stock assessment]{.blue-title}

[Nicholas Ducharme-Barth & Megumi Oshima]{.bg style="font-size:0.75em;"}

[2024-11-05]{.bg style="font-size:0.5em;"}
:::
...
**Example**: [Fitting large spatiotemporal model in R](https://arxiv.org/abs/2304.09442) using TMB required [128 CPUs & 1TB RAM]{.blue}.
:::
:::
...
::: {.fragment .fade-in fragment-index=5}
- Uses [Slurm](https://slurm.schedmd.com/documentation.html){preview-link="true"} to schedule HPC [(or HTC)]{.fragment .hl-blue fragment-index=6} workflows
:::
...
::: {.fragment .semi-fade-out fragment-index=3}
Many may already be using containers in existing cloud-based workspaces such as [GitHub Codespaces]{.fragment .hl-cur-black fragment-index=1} or [Posit Workbench]{.fragment .hl-cur-pc-orange fragment-index=2}
:::
...
::: {.fragment .fade-in fragment-index=1}
In this case we will use [NOAA Hera](https://docs.rdhpcs.noaa.gov/systems/hera_user_guide.html){preview-link="true"} to conduct a quick retrospective analysis of all models in the [Stock Synthesis](https://github.com/nmfs-ost/ss3-source-code) (SS3) [testing suite](https://github.com/nmfs-ost/ss3-test-models).
:::
...
Note that you will need to replace [User.Name]{.blue} with your actual NOAA RDHPCS user name and [project_name]{.blue} with your specific Hera project name in the following code.
...
::: {.absolute top="85%" width="100%" style="font-size:0.65em;"}
...
Slide design influenced by [Emil Hvitfeldt](https://emilhvitfeldt.com/blog){preview-link="true"}'s published examples.
